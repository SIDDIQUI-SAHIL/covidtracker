    ...
    <div className="app">
      <div className="app__left">
        ...
        <div className="subject__div">
          <h4 className="subject">Developed and maintained by <a class="anchort" href="https://www.linkedin.com/in/sahil-siddiqui-8416b8195/" target="_blank" rel="noreferrer">Sahil Siddiqui</a></h4>
          <br />
          <h4 className="subject">Updates made in realtime based on data provided by <a class="anchort" href="https://disease.sh/" target="_blank" rel="noreferrer">Disease.sh</a></h4>
